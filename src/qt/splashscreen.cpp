    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    if (titleTextWidth > 210) {
        fontFactor = fontFactor * 210 / titleTextWidth;
    }
    ...
    pixPaint.drawText(pixmap.width()/devicePixelRatio-titleTextWidth-paddingRight+70,paddingTop+titleVersionVSpace,versionText);

    // draw copyright stuff
    {
        pixPaint.setFont(QFont(font, 15*fontFactor));
        const int x = pixmap.width()/devicePixelRatio-titleTextWidth-paddingRight+70;
