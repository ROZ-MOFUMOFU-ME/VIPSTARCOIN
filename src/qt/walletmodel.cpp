...
void WalletModel::subscribeToCoreSignals()
{
    ...
    wallet->NotifyContractBookChanged.connect(boost::bind(NotifyContractBookChanged, this, boost::placeholders::_1, boost::placeholders::_2, boost::placeholders::_3, boost::placeholders::_4, boost::placeholders::_5));
}
...
void WalletModel::unsubscribeFromCoreSignals()
{
    ...
    wallet->NotifyContractBookChanged.disconnect(boost::bind(NotifyContractBookChanged, this, boost::placeholders::_1, boost::placeholders::_2, boost::placeholders::_3, boost::placeholders::_4, boost::placeholders::_5));
}
